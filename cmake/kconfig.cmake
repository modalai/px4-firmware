	...
	foreach(NameAndValue ${ConfigContents})
		...
		if(Drivers)
			...
			elseif(EXISTS ${PX4_SOURCE_DIR}/src/drivers/${driver_p5_folder}/${driver_p5_subfolder}/${driver_p5_subsubfolder})
				...
				message(STATUS "Looking in drivers/${driver}")
				message(STATUS "Looking in drivers/${driver_path}")
				message(STATUS "Looking in drivers/${driver_p3_folder}/${driver_p3_subfolder}/${driver_p3_subsubfolder}")
				message(STATUS "Looking in drivers/${driver_p1_folder}/${driver_p1_subfolder}")
				message(STATUS "Looking in drivers/${driver_p4_folder}/${driver_p4_subfolder}")
				message(STATUS "Looking in drivers/${driver_p2_folder}/${driver_p2_subfolder}")
				message(STATUS "Looking in drivers/${driver_p5_folder}/${driver_p5_subfolder}/${driver_p5_subsubfolder}")
