...
def main():
    ...
    parser.add_argument('--rc_channel_json', '-rc', type=bool, required=False)
    parser.add_argument('--radio_status_json', '-rs', type=bool, required=False)
    ...
    if(args.rc_channel_json or args.radio_status_json):
        if(args.rc_channel_json):
            ...
            data_dict["param_name"] = str(args.parameter_name)
