...
for pkg in $DEPS; do
	...
	sudo dpkg-deb -x $pkg*.deb /home/tmp
	cp -r /home/tmp/usr/include/* /home/4.1.0.4/tools/linaro64/aarch64-linux-gnu/include
	cp -r /home/tmp/usr/lib64/* /home/4.1.0.4/tools/linaro64/aarch64-linux-gnu/lib64
	rm -f $pkg*.deb
	rm -fR /home/tmp
done
