...
typedef int (*flush_uart_func_t)(int fd);
typedef int (*uart_poll_func_t)(int fd, void (*)(int));

void configure_uart_callbacks(open_uart_func_t, write_uart_func_t, read_uart_func_t, flush_uart_func_t, uart_poll_func_t);
